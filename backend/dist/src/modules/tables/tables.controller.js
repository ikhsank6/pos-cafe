...
let TablesController = class TablesController {
    ...
    async findAll(query, status, location) {
    ...
    async create(createTableDto, req) {
        return this.tablesService.create(createTableDto, req.user?.uuid);
    }
    async update(uuid, updateTableDto, req) {
    ...
    async updateStatus(uuid, body, req) {
        return this.tablesService.updateStatus(uuid, body.status, req.user?.uuid);
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, table_dto_1.UpdateTableDto, Object]),
    __metadata("design:returntype", Promise)
...
exports.TablesController = TablesController = __decorate([
    (0, swagger_1.ApiTags)('4. Table Management : Tables'),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, common_1.Controller)('table-management/tables'),
